 ...
 */
public final class RMatrix2D implements RMatrix {
    ...
    public RMatrix2D(float m00, float m01, float m02,
                     float m10, float m11, float m12) {
        set(m00, m01, m02,
                m10, m11, m12);
    }

    public RMatrix2D(RMatrix RMatrix) {
        set(RMatrix);
    }
     ...
     */
    public RMatrix2D get() {
        RMatrix2D outgoing = new RMatrix2D();
        outgoing.set(this);
        return outgoing;
    }
    ...
    public void set(RMatrix RMatrix) {
        if (RMatrix instanceof RMatrix2D) {
