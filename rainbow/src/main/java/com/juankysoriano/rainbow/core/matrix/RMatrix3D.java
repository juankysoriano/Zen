 ...
 */
public final class RMatrix3D implements RMatrix /* , PConstants */ {
    ...
    protected RMatrix3D inverseCopy;
    ...
    public RMatrix3D(float m00, float m01, float m02, float m10, float m11, float m12) {
        set(m00, m01, m02, 0, m10, m11, m12, 0, 0, 0, 1, 0, 0, 0, 0, 1);
    }

    public RMatrix3D(float m00, float m01, float m02, float m03, float m10, float m11, float m12, float m13, float m20, float m21, float m22, float m23, float m30, float m31, float m32, float m33) {
        set(m00, m01, m02, m03, m10, m11, m12, m13, m20, m21, m22, m23, m30, m31, m32, m33);
    }

    public RMatrix3D(RMatrix RMatrix) {
        set(RMatrix);
    }

    public void set(RMatrix RMatrix) {
        if (RMatrix instanceof RMatrix3D) {
            RMatrix3D src = (RMatrix3D) RMatrix;
            ...
            RMatrix2D src = (RMatrix2D) RMatrix;
     ...
     */
    public RMatrix3D get() {
        RMatrix3D outgoing = new RMatrix3D();
        outgoing.set(this);
        return outgoing;
    }
    ...
    public void apply(RMatrix source) {
        if (source instanceof RMatrix2D) {
            apply((RMatrix2D) source);
        } else if (source instanceof RMatrix3D) {
            apply((RMatrix3D) source);
        }
    }
    ...
    public RVector mult(RVector source, RVector target) {
        ...
        target.set(m00 * source.x + m01 * source.y + m02 * source.z + m03, m10 * source.x + m11 * source.y + m12 * source.z + m13, m20 * source.x + m21 * source.y + m22 * source.z + m23);
    ...
    protected boolean invApply(float n00,
                               float n01,
                               float n02,
                               float n03,
                               float n10,
