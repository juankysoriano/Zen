...
<xsl:stylesheet version="1.0" xmlns="http://www.w3.org/1999/xhtml" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:output method="xml" omit-xml-declaration="yes" standalone="yes" doctype-system="http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"
      ...
      <body>
        ...
        <xsl:for-each select="$unique-catkey">
          ...
          <xsl:call-template name="generateWarningTable">
            ...
            <xsl:with-param name="sectionId">Warnings_
