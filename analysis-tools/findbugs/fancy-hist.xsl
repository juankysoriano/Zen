      ...
      <head>
        ...
        <script type='text/javascript'>
          ...
          <xsl:for-each select="/BugCollection/BugPattern">
            ...
            [ "<xsl:value-of select="@category" />", "<xsl:value-of select="@abbrev" />", "<xsl:value-of select="@type" />", "<xsl:value-of
          ...
          <xsl:for-each select="/BugCollection/FindBugsSummary/PackageStats/ClassStats">
            ...
            [ "<xsl:value-of select="@class" />", "<xsl:value-of select="../@package" />", "<xsl:value-of select="@interface" />", "<xsl:value-of
            select="@bugs" />", "<xsl:value-of select="@priority_1" />", "<xsl:value-of select="@priority_2" />", "<xsl:value-of
            select="@priority_3" />", "<xsl:value-of select="@priority_4" />" ],
          </xsl:for-each>
          [ "", "", "", "", "", "", "", "" ]
          );
          ...
          <xsl:for-each select="/BugCollection/FindBugsSummary/PackageStats">
            ...
            [ "<xsl:value-of select="@package" />", "<xsl:value-of select="@total_bugs" />", "<xsl:value-of select="@priority_1" />", "<xsl:value-of
            select="@priority_2" />", "<xsl:value-of select="@priority_3" />", "<xsl:value-of select="@priority_4" />" ],
          </xsl:for-each>
          [ "", "", "", "", "", "" ]
          );
        ...
        <div id='menuWrapper' style=''>
          <div id="navcontainer">
            <ul id="navlist">
              ...
              <li>
                <a id='listByCategories' class="none" href="#" onclick="selectMenu('listByCategories'); return false;">Browse By Categories</a>
              </li>
              <li>
                <a id='listByPackages' class="none" href="#" onclick="selectMenu('listByPackages'); return false;">Browse by Packages</a>
              </li>
              <li>
            ...
            <div id='historyControlWrapper' style='display:none;'>
              <form name="findbugsHistoryControlForm">
                <div id='historyControlContainer'>
                  <input type='checkbox' name='includeFixedIntroducedBugs' value='checked' alt='Include fixed introduced bugs.'
